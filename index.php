...
<head>
    ...
    <title>Inicio - Accesos Inclusivos</title>
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="72">
        ...
        <div class="container"><a class="navbar-brand" href="#page-top">Accesos Inclusivos</a><button data-bs-toggle="collapse" data-bs-target="#navbarResponsive" class="navbar-toggler text-white bg-primary navbar-toggler-right text-uppercase rounded" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="locations.php">UBICACIONES</a></li>
    ...
    <section class="text-white bg-primary mb-0" id="about">
        <div class="container">
            <h2 class="text-uppercase text-center text-white">ACERCA DE</h2>
            <div class="row">
                <div class="col-lg-4 ms-auto">
                    <p class="lead">Somos un equipo de estudiantes que desarrollan un proyecto web para la Feria de Ciencias.</p>
                </div>
                <div class="col-lg-4 me-auto">
                    <p class="lead">Nuestro proyecto busca apoyar a quienes cuenten con discapacidad y dificultad para desplazarse en la ciudad.</p>
                </div>
            </div>
        </div>
    </section>
